...
## Financial Analyst — 86 postings from 57 companies (updated 2026-09-21)
Covered by 6 existing sims: investment trade-off, pricing strategy analysis, recommendation, unit economic

Uncovered processes (top by demand share — tools shown as context, not gaps):
1. **financial modeling** — 49% of postings [deliverables] · [claim → gap:financial-modeling](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Afinancial-modeling)
   - typical flow: define planning calendar and timeline → gather financial data → financial analysis → analyze supply chain cost → analyze cost data → data analysis
   - tools seen: financial modeling software (57%), excel (40%), data visualization software (36%), business intelligence software (26%)
2. **forecasting** — 41% of postings [responsibilities] · [claim → gap:forecasting](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Aforecasting)
   - typical flow: gather financial data → investment planning → financial modeling → analyze trend → budgeting → forecasting
   - tools seen: excel (34%), financial modeling software (34%), sql (17%), data visualization software (14%)
3. **report** — 38% of postings [deliverables] · [claim → gap:report](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Areport)
   - typical flow: research and reconcile transaction → financial analysis → gather financial data → analyze supply chain cost → analyze cost data → initiate and coordinate audit
   - tools seen: financial modeling software (45%), data visualization software (36%), business intelligence software (33%), excel (21%)
4. **forecast** — 34% of postings [deliverables] · [claim → gap:forecast](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Aforecast)
   - typical flow: gather financial data → financial report → financial modeling → forecasting → management report → variance analysis
   - tools seen: excel (48%), financial modeling software (31%), sql (17%), google sheets (17%)
5. **financial performance analysis** — 30% of postings [responsibilities] · [claim → gap:financial-performance-analysis](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Afinancial-performance-analysis)
   - typical flow: gather financial data → analyze financial result → financial analysis → financial modeling → management report → forecasting
   - tools seen: financial modeling software (38%), excel (31%), data visualization software (31%), google sheets (12%)
6. **financial analysis** — 27% of postings [responsibilities] · [claim → gap:financial-analysis](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Afinancial-analysis)
   - typical flow: gather financial data → research and reconcile transaction → financial analysis → financial report → initiate and coordinate audit → financial modeling
   - tools seen: financial modeling software (35%), excel (17%), data visualization software (13%), business intelligence software (9%)
7. **financial report** — 24% of postings [deliverables] · [claim → gap:financial-report](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Afinancial-report)
   - typical flow: financial analysis → report → financial report → variance analysis
   - tools seen: excel (43%), financial modeling software (38%), data visualization software (19%), oracle (10%)
8. **budgeting** — 22% of postings [responsibilities] · [claim → gap:budgeting](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Abudgeting)
   - typical flow: investment planning → data analysis → financial modeling → analyze trend → budgeting → financial report
   - tools seen: financial modeling software (42%), excel (32%), data visualization software (11%), workday (11%)
9. **financial reporting** — 22% of postings [responsibilities] · [claim → gap:financial-reporting](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Afinancial-reporting)
   - typical flow: financial analysis → financial report → analyze trend → forecasting → variance analysis → month-end close
   - tools seen: excel (42%), financial modeling software (26%), workday (21%), google sheets (16%)
10. **cost analysis** — 22% of postings [responsibilities] · [claim → gap:cost-analysis](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Acost-analysis)
   - typical flow: analyze financial result → analyze supply chain cost → analyze cost data → financial modeling → management report → build financial model and report
   - tools seen: financial modeling software (68%), business intelligence software (53%), data visualization software (53%), excel (16%)

## Data Analyst — 82 postings from 29 companies (updated 2026-09-21)
...
3. **digital product** — 26% of postings [deliverables] · [claim → gap:digital-product](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Adigital-product)
   - typical flow: analyze respiratory and health data → design risk model → inform digital product
...
7. **analyze health data** — 23% of postings [responsibilities] · [claim → gap:analyze-health-data](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Aanalyze-health-data)
   - tools seen: blockchain (100%)
8. **translate clinical insight** — 23% of postings [responsibilities] · [claim → gap:translate-clinical-insight](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Atranslate-clinical-insight)
   - tools seen: blockchain (100%)
9. **analyze respiratory data** — 23% of postings [responsibilities] · [claim → gap:analyze-respiratory-data](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Aanalyze-respiratory-data)
   - tools seen: blockchain (100%)
10. **design risk model** — 23% of postings [responsibilities] · [claim → gap:design-risk-model](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Adesign-risk-model)
   - tools seen: blockchain (100%)

## Security Analyst — 67 postings from 45 companies (updated 2026-09-21)
**No sims cover this family yet — the whole head is open.**

Uncovered processes (top by demand share — tools shown as context, not gaps):
1. **incident response** — 37% of postings [responsibilities] · [claim → gap:incident-response](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Aincident-response)
   - typical flow: detect incident → alert triage → analyze security incident → incident response → contain and remediate → incident report
   - tools seen: siem (32%), python (28%), aws (20%), edr (20%)
2. **incident report** — 31% of postings [deliverables] · [claim → gap:incident-report](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Aincident-report)
   - typical flow: detect incident → monitor security event → alert triage → analyze incident → analyze security incident → incident response
...
## Account Manager — 5 postings from 3 companies (updated 2026-09-21)
**No sims cover this family yet — the whole head is open.**

Uncovered processes (top by demand share — tools shown as context, not gaps):
1. **client relationship management** — 60% of postings [responsibilities] · [claim → gap:client-relationship-management](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Aclient-relationship-management)
   - typical flow: financial performance analysis → investment planning → pipeline → territory plan → competitive analysis → build growth roadmap
   - tools seen: ai tool (100%), bi tool (33%), salesforce (33%), agentic enablement capabilitie (33%)
2. **territory plan** — 40% of postings [responsibilities] · [claim → gap:territory-plan](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Aterritory-plan)
   - typical flow: financial performance analysis → pipeline → territory plan → client relationship management → build growth roadmap → negotiation guide
   - tools seen: ai tool (100%), bi tool (50%), salesforce (50%), notion (50%)
3. **cross-functional collaboration** — 40% of postings [responsibilities] · [claim → gap:cross-functional-collaboration](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Across-functional-collaboration)
...
4. **long range plan** — 40% of postings [responsibilities] · [claim → gap:long-range-plan](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Along-range-plan)
   - typical flow: financial performance analysis → pipeline → territory plan → client relationship management → build growth roadmap → negotiation guide
   - tools seen: ai tool (100%), bi tool (50%), salesforce (50%), notion (50%)
5. **executive presentation** — 40% of postings [responsibilities] · [claim → gap:executive-presentation](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Aexecutive-presentation)
   - typical flow: investment planning → pipeline → competitive analysis → cross-functional collaboration → client relationship management → own end-to-end operationalization of program
   - tools seen: ai tool (100%), agentic enablement capabilitie (50%), partner program tech stack (50%), notion (50%)
6. **lead and develop team** — 40% of postings [responsibilities] · [claim → gap:lead-and-develop-team](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Alead-and-develop-team)
   - typical flow: investment planning → pipeline → competitive analysis → cross-functional collaboration → client relationship management → own end-to-end operationalization of program
   - tools seen: ai tool (100%), agentic enablement capabilitie (50%), partner program tech stack (50%), notion (50%)
...
## Cloud Data Engineer — 28 postings from 15 companies (updated 2026-09-21)
**No sims cover this family yet — the whole head is open.**
...
3. **architecture and design decision** — 21% of postings [decisions] · [claim → gap:architecture-and-design-decision](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Aarchitecture-and-design-decision)
   - tools seen: python (67%), azure (50%), gcp (50%), javascript (50%)
4. **pipeline** — 21% of postings [deliverables] · [claim → gap:pipeline](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Apipeline)
   - tools seen: python (50%), typescript (33%), apache spark (33%), delta lake (33%)
5. **documentation** — 21% of postings [deliverables] · [claim → gap:documentation](https://github.com/SkillSimm/skillsimm-template-submissions/issues?q=is%3Aissue+label%3Agap%3Adocumentation)
   - typical flow: design architecture
...
## Risk Compliance Manager — 14 postings from 1 companies (updated 2026-09-21)
**No sims cover this family yet — the whole head is open.**
